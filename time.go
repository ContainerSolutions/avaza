...
const (
	...
	AvazaTimeFormat = "2019-02-11T11:07:42.1233333"
...
var (
	dateTimeFormats = []string{RFC3339Micro, RFC3339Millis, time.RFC3339, time.RFC3339Nano, ISO8601LocalTime, AvazaTimeFormat}
